...
INITIALIZATION_SECTION
 ...
 log_a50_fish3_m        1.13279115361
 log_a50_fish3_f        1.13279115361
 ...
 log_a50_srv10_f         1.00000002481 
 log_delta_srv10_f         1.75000000000
 log_a50_srv10_m       1.00000000825
 log_delta_srv10_m        1.55000000000
 log_a50_fish5_f        1.13279115361
 log_delta_fish5_f        0.723340585591
 log_a50_fish5_m        1.15627997343
 log_delta_fish5_m         0.945517826919

 log_q_LL_fish_recent       1.1713
 log_a50_fish1_f      1.43514 
 log_delta_fish1_f    -0.879853
 log_a50_fish1_m      2.07769
 log_a50_fish2      1.83096 
 log_delta_fish2      4.56197 
 log_delta_fish3_f      2.32852
 log_delta_fish3_m      2.26079 
...
// ########################################################################################################
  ...
  init_bounded_number   log_mean_rec(-1,5,ph_mean_rec);          // Unfish equil recruitment (logged) (estimated)
  init_bounded_number   sigr(0.1,2,ph_sigr);           // Recruitment sdev parameter  (not estimated)

 // Parameters for computing SPR rates
// ########################################################################################################
  init_bounded_number   mF50(0.01,1.,ph_F50)            // Estimated F50 (phase hardwired in tpl data section to 6)
  init_bounded_number   mF40(0.01,1.,ph_F50)            // Estimated F40 (phase hardwired in tpl data section to 6)
  init_bounded_number   mF35(0.01,1.,ph_F50)            // Estimated F35 (phase hardwired in tpl data section to 6)

 // Natural Mortality
//###########################################################################################################
  init_number           logm(ph_m);                            // Estimate log natural mortality (estimated)
...
// ########################################################################################################
 ...
 //    qsrvy 9 is only estimated if qsrvy2 is not estimated 
  init_bounded_number           log_q_srv1(-1,3,ph_q_srv1);           // Estimate Log survey catchability for DOM LL SRV RPN/RPW        (estimated)
  init_bounded_number           log_q_srv2(-1,3,ph_q_srv2);           // Estimate Log survey catchability for JPN LL SRV RPN/RPW        (estimated)
  init_bounded_number           log_q_srv3(-1,3,ph_q_srv3);                  // Estimate Log survey catchability use same value as q1          (not estimated)
  init_bounded_number           log_q_srv4(-1,3,ph_q_srv4);                  // Estimate Log survey catchability use same value as q2          (not estimated)
  init_bounded_number           log_q_srv5(-1,3,ph_q_srv5);           // Estimate Log survey catchability DOM LL fishery RPW            (estimated)
  init_bounded_number           log_q_srv6(-1,3,ph_q_srv6);           // Estimate Log survey catchability JPN LL fishery RPW            (estimated)
  init_bounded_number           log_q_srv7(-1,3,ph_q_srv7);           // Estimate Log survey catchability DOM trawl survey              (estimated)
  init_bounded_number           log_q_srv8(-1,3,ph_q_srv8);           // Estimate Log survey catchability DOM LL fishery RPW post-IFQ   (estimated)
  init_bounded_number           log_q_srv9(-1,3,ph_srv2_q2);         // Estimate Log survey catchability JPN LL SRV RPN/RPW 1990-1994  (set to qsrv2 unless qsrv2 not estimated)
  init_bounded_number           log_q_LL_srvy_recent(-1,3,ph_q_LL_srv_rec);  // estimate log survey catchability for DOM LL SRVY RPN recent time block
  init_bounded_number           log_q_LL_fish_recent(-1,3,ph_q_IFQ_rec);  // estimate log fishery catchability for DOM LL fishery RPW recent time block
 ...
 // ########################################################################################################
  ...
  init_bounded_number   log_a50_fish1_f(0,2.5,ph_fish_sel);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_fish1_f(-10,10,ph_fish_sel_delt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_fish1_m(0,3,ph_fish_sel);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_fish1_m(-10,10,ph_fish_sel_delt_alt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number       log_a50_fish2(0,3,ph_fish2_sel);                 // age at 50% selection                                                   
  init_bounded_number       log_delta_fish2(-10,10,ph_fish_sel_delt_alt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_fish3_f(0,3,ph_fish_sel);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_fish3_f(-10,10,ph_fish_sel_delt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_fish3_m(0,10,ph_fish_sel);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_fish3_m(-10,10,ph_fish_sel_delt_alt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_fish4_f(0,3,ph_ifq);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_fish4_f(-10,10,ph_fish_sel_delt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_fish4_m(0,3,ph_ifq);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_fish4_m(-10,10,ph_fish_sel_delt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_fish5_f(0,3,ph_ifq_block2);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_fish5_f(-10,10,ph_ifq_block2);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_fish5_m(0,3,ph_ifq_block2);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_fish5_m(-10,10,ph_ifq_block2);                 // age between 50% selection and 95% selection....
...
// ########################################################################################################
  ...
  init_bounded_number   log_a50_srv1_f(0,3,ph_srv1_sel);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_srv1_f(-10,10,ph_srv_sel_delt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_srv1_m(0,3,ph_srv1_sel);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_srv1_m(0.1,3,ph_srv_sel_delt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_srv2_f(0,3,ph_srv2_sel);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_srv2_f(-10,10,ph_srv_sel_delt_alt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_srv2_m(0,3,ph_srv2_sel);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_srv2_m(-10,10,ph_srv_sel_delt_alt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_srv7_f(-40,5,ph_srv1_sel);                 // age at 50% selection                                                   
  ...
  init_bounded_number   log_a50_srv7_m(-40,5,ph_srv1_sel);                 // age at 50% selection                                                   
  ...
  init_bounded_number   log_a50_srv10_f(0,3,ph_LL_block2);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_srv10_f(-10,10,ph_srv_sel_delt_alt);                 // age between 50% selection and 95% selection....
  ...
  init_bounded_number   log_a50_srv10_m(0,3,ph_LL_block2);                 // age at 50% selection                                                   
  init_bounded_number   log_delta_srv10_m(-10,10,ph_srv_sel_delt_alt);                 // age between 50% selection and 95% selection....
...
// Start year
 ...
 switch (SrType)
  {
    ...
    for (j=2;j<nages;j++)
     {
      itmp = styr+1-j;
       ...
       natage_f(styr,j) =( mfexp(log_mean_rec  - (M(styr,j)+hist_hal_F*fish1_sel_f(j)) * double(j-1)+ log_rec_dev(itmp)+sigr*sigr/2))/2; 
       natage_m(styr,j) = (mfexp(log_mean_rec  - (M(styr,j)+mdelta+hist_hal_F*fish1_sel_m(j)) * double(j-1)+ log_rec_dev(itmp)+sigr*sigr/2))/2; 
     }
    ...
    // ########## calc for plus group
      ...
      natage_m(styr,nages)      = (mfexp(log_mean_rec - (M(styr,nages-1)+mdelta+hist_hal_F*fish1_sel_m(nages-1)) * (nages-1))/ (1. - exp(-(M(styr,nages-1)+mdelta+hist_hal_F*fish1_sel_f(nages-1))) ))/2;
     }
    break;
   }
 ...
 // FIll in abundance matrix until last year of recruit devs
  for ( i=styr;i <= endyr_rec;i++)
   {
     natage_f(i,1)           = mfexp(log_rec_dev(i) + log_mean_rec+sigr*sigr/2 )/2;  //fill in recruitment in current year
...
FUNCTION Get_Predicted_Values
 ...
 // ###############################################################################################################################################################################
   ...
   q_LL_fish_recent = exp(log_q_LL_fish_recent);
   q_LL_srvy_recent = exp(log_q_LL_srvy_recent);
    ...
    if(i>=yr_sel_chg_srv1)
     {
      ...
      if(ph_LL_block2>0 && ph_q_LL_srv_rec<1)  // if estimating new selectivity for recent time block then use srv10 selectivity AND NEW Q
       {   
        pred_srv1(i) = 2*(q_srv1 * (1-prop_m(i))*(elem_prod(S_f_mid(i),natage_f(i))*elem_prod(srv10_sel_f,weight_f(i)))+q_LL_srvy_recent*prop_m(i)* (elem_prod(S_m_mid(i),natage_m(i))*elem_prod(srv10_sel_m,weight_m(i))));   // Predicted Survey biomass
        pred_srv3(i) = 2*(q_srv1 * (1-prop_m(i))*(elem_prod(S_f_mid(i),natage_f(i))*srv10_sel_f)+q_LL_srvy_recent *prop_m(i)* (elem_prod(S_m_mid(i),natage_m(i))*srv10_sel_m));   // Predicted Survey biomass
       } 
...
FUNCTION write_sarareport
 ...
 sarareport<<"\"A full assessment was undertaken in 2021. Moderate changes were implemented for the final  model for 2021. The model used for sablefish assessments since 2016 (model 16.5) was replaced by model 21.12.\""<<endl;
 sarareport<<"\"Model changes include: updated length-, weight-, and maturity-at-age inputs; removal of all catchability priors; the addition of a new time block (starting in 2016) for the estimation of fishery catchability and selectivity and longline survey selectivity parameters; and the implementation of Francis data reweighting.\""<<endl;
